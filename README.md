...
### Backend (FastAPI)
- In-memory pod registry with heartbeat monitoring
- Fault injection endpoints (delay, error rate, kill)
- Health status calculation (Healthy/Degraded/Down)
- SLO calculation and burn rate tracking
- Prometheus-style metrics endpoint

### Frontend (React)
- Service cards with status indicators
- Fault injection controls
- Real-time charts (latency, error rate, health)
...
│   │   │   ├── SLODashboard.js   # SLO metrics dashboard
